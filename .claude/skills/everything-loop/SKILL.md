---
name: everything-loop
description: Use when in an everything-loop session, when system message shows "Everything Loop iteration", when continuing autonomous development work.
---
